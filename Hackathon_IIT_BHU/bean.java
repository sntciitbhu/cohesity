...
public class bean {
    private String one="Planning a pregnancy, being pregnant and breastfeeding are really important times to review your own nutrition and eating habits.\n" +
            "\n" +
            ...
            "\n" +
            "If you need some personal help to change your habits and eat a more healthy diet the free Get Healthy in Pregnancy service might be for you.  Call on 1300 806 258 or visit the website (opens in a new window)\n" +
            "\n" +
            ...
            "\n" +
            "The Australian Guide to Healthy Eating (opens in a new window) can help you understand what foods you need everyday.\n" +
            "\n" +
            ...
            "\n" +
            "Find out how many serves of each food group (opens in a new window)you need while you’re pregnant.\n" +
            "\n" +
            ...
            "\n" +
            "The listeria bacteria (opens in a new window) are found in nature and in some foods, both home-cooked and bought food. While listeria infection is uncommon and causes few or no symptoms in healthy people, it can be very dangerous.\n" +
            "\n" +
            ...
            "\n" +
            "Check how many serves of each food group you need while you are breastfeeding (opens in a new window).\n" +
            "\n" +
            ...
            "Find out how your diet, while pregnant or breastfeeding, compares to the Australian Dietary Guidelines, by taking this quiz (opens in a new window) from the Dietitians Association of Australia.\n" +
            "\n" +
            ...
            "Download the ‘Nutrition for Pregnancy and Breastfeeding (opens in a new window)’ booklet.\n" +
            "\n" +
            ...
            "\n" +
            "Find out more about reducing the risks of smoking to your baby (opens in a new window) and to your own.",
            two="Giving babies and young children the best start in life\n" +
                    ...
                    "\n" +
                    "being able to hold his/her head up and sit with support\n" +
                    "looking, reaching and grabbing for food\n" +
                    "baby seems hungry even after a full breastfeed or bottle, and\n" +
                    "baby progresses from sucking to biting.\n" +
                    ...
                    "Don’t give babies:\n" +
                    "\n" +
                    "drinks high in sugar (such as soft drinks, fruit juice, fruit drinks);\n" +
                    "all teas, coffee\n" +
                    "soy, rice, oat, almond or other cereal or nut based drinks\n" +
                    "You can find more about what, how and why to give various foods to babies, by reading the pamphlet: Giving your baby the best start-the best foods for infants (opens in a new window). For more detailed information, see the Infant Feeding Guidelines Summary (opens in a new window).\n" +
                    "\n" +
                    ...
                    "nuts\n" +
                    "hard lollies\n" +
                    "raw hard fruit and vegies (e.g. apple, carrot and celery)\n" +
                    "round foods (e.g. grapes and cherry tomatoes)\n" +
                    "foods with skins (e.g. frankfurters).\n" +
                    "For tips on making young children’s foods safer, read the \"Preventing choking on food (opens in a new window)\" pamphlet.\n" +
                    "\n" +
                    "Good food and eating well\n" +
                    "Healthy eating means enjoying a variety of foods from each of the Five Food Groups every day.\n" +
                    "\n" +
                    "The Australian Guide to Healthy Eating (opens in a new window) provides information about the Five Food Groups which young children and adults need each day:\n" +
                    "\n" +
                    "plenty of vegetables of different types and colours, and legumes or beans\n" +
                    "fruit\n" +
                    "grain (cereals) foods, mostly wholegrain and /or high cereal fibre varieties such as breads, cereals, rice, pasta, noodles, polenta, couscous, oats, quinoa and barley\n" +
                    ...
                    "The Australian Guide to Healthy Eating (opens in a new window) also recommends we drink plenty of water, and limit discretionary foods (opens in a new window). Children should not be offered discretionary foods every day, as they are poor sources of important nutrients children need for growth and development. ‘Discretionary’ foods and drinks include sweet biscuits, cakes, desserts and pastries; processed meats and fattier/salty sausages; sweetened condensed milk; ice cream and other ice confections; confectionary and chocolate; savoury pastries and pies; commercial burgers with a high fat and/or salt content; commercially fried foods; potato chips, crisps and other fatty and/or salty snack foods including some savoury biscuits; cream, butter and spreads which are high in saturated fats; sugar-sweetened soft drinks and cordials, sports and energy drinks and alcoholic drinks.\n" +
                    "\n" +
                    "For more information about the Five Food Groups and how much you and your family need from each food group every day, see:\n" +
                    "\n" +
                    "Recommended number of serves for children, adolescents and toddlers (opens in a new window)\n" +
                    "Recommended number of serves for adults (opens in a new window)\n" +
                    "Eat for Health sample meal plans (opens in a new window) for men (opens in a new window), women (opens in a new window), and children (9-11 years) (opens in a new window)\n" +
                    "Australian Dietary Guidelines Summary (opens in a new window)\n",
            three="We all know how important it is for children and teens to make healthy food and activity choices (opens in a new window). But, while it may be easy to say, it’s not always so easy to do!\n" +
                    "\n" +
                    ...
                    "\n" +
                    "plenty of vegetables, legumes and fruit (opens in a new window)\n" +
                    ...
                    "Every child is different, and the amount of each of the food groups they’ll need will depend on age, body size and activity level, but there are recommendations (opens in a new window) for how many serves of each food group children and teens normally need.\n" +
                    "\n" +
                    ...
                    "\n" +
                    "The Women’s and Children’s Health Network (opens in a new window) has all sorts of information about dealing with the changing eating habits of teenagers (opens in a new window), which can be brought about by:\n" +
                    "\n" +
                    "growth spurts\n" +
                    ...
                    "To see how your child or teen’s diet compares with the Australian Dietary Guidelines, try this quiz (opens in a new window) from the Dietitians Association of Australia with them.\n" +
                    "\n" +
                    ...
                    "choose tv programs that advertise lower amounts of junk food advertising. Use the Cancer Council’s Fat Free TV (opens in a new window) guide to find out what your kids are seeing on TV and to help you make healthier viewing choices\n" +
            ...
            four="What is healthy eating?\n" +
                    ...
                    "\n" +
                    "The Australian Guide to Healthy Eating (opens in a new window) can help us understand what foods we need each day. We should aim to eat:\n" +
                    "\n" +
                    ...
                    "body size\n" +
                    "activity level.\n" +
                    "Find out how many serves of each food group (opens in a new window) you need.\n" +
                    "\n" +
                    "Is your eating on track?\n" +
                    "To see how your diet compares with the Australian Dietary Guidelines, try this quiz (opens in a new window) from the Dietitians Association of Australia.\n" +
                    "\n" +
                    "Need some help?\n" +
                    ...
                    "\n",
            five="Healthy eating as we get older\n" +
                    ...
                    "\n" +
                    "Eat foods that are high in nutrients from the five food groups pictured in the Australian Guide to Healthy Eating (opens in a new window) including:\n" +
                    "\n" +
                    ...
                    "\n" +
                    "Hints and tips to make it easier\n" +
                    "It can be hard coming up with new and interesting food options so why not have a look at these inspiring snack, lunchbox and meal ideas and new recipes?\n" +
                    "\n" +
