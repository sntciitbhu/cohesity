    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand " href="home.html">SYNAPESE</a>
            </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-hand-holding-heart"></i> Blood Requests
                            </li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel-default">
                            ...
                            $id=1;
                            include('server.php');
                            $sql="SELECT * FROM blood_orders";
                            $query=mysqli_query($db,$sql);
                            $result=mysqli_num_rows($query);
                            if($result>0)
                            {
                                echo '<table class="table table-striped table-bordered table-hover table-condensed">';
                                echo '<tr><th>id</th><th>name</th><th>Address</th><th>Aadhar</th><th>Delivery Address</th><th>Contact Number</th><th>Blood Group</th><th>Amount</th>';
