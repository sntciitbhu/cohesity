...
$db = mysqli_connect('localhost','root','','datahospital');
...
if(!empty($_POST['submit']))
{
    ...
    if(count($errors)==0)
    {
        $sql= "INSERT INTO blood_orders (name,address,aadhar,name_of_hospital,mobile_number,booking_date) VALUES ('$username','$Address','$Aadhar','$daddress','$mobile','$bdate')";
        ...
        <div id="wrapper">
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand " href="index.php">SYNAPESE</a>
                </div>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Hospital Management</h1>
                            <ol class="breadcrumb">
                            <li class="active">
                                    ...
                                    <div class="col-md-12">
                                        <form action="bloodbook.php" method="post" role="list" style="display: block">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                   <input type="date" name="bdate" class="form-control" placeholder="Mobile Number" required> 
                                                </div>
                                            </div>
                                            <br>
                                            <br>
