...
<body background="${pageContext.request.contextPath}/resources/images/back2.jpg">
	...
	<div class="loginBox">
       ...
       <form:form method="post" action="/dbms_project/provider/save">  
      	<table id="tab">  
         <tr>  
          <td>Name : </td> 
          <td><form:input path="provider_Name"  required="true" /></td>
         </tr>  
         <tr>  
         ...
         <tr>  
          <td>Godown Number :</td>  
          <td><form:input path="godown_No" required="true" type="number"/></td>
         </tr>
         <tr>  
          <td>Street :</td>  
