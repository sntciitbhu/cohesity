...
<body background="${pageContext.request.contextPath}/resources/images/back2.jpg">
	<c:url value="/j_spring_security_logout" var="logoutUrl" />
		...
		<div class="loginBox">
	<h1>Payments to Providers</h1>
	<table id="tab">
	<tr><th>Id</th><th>Provider Name</th><th>Total Transactions</th><th>Total Bill</th><th>IFSC Code</th><th>Account Number</th></tr>
    <c:forEach var="prov" items="${list}"> 
    <tr>
    <td>${prov.provider_ID}</td>
    <td>${prov.provider_Name}</td>
    <td>${cntmap.get(prov.provider_ID)}</td>
    <td>${totalmap.get(prov.provider_ID)}</td>
